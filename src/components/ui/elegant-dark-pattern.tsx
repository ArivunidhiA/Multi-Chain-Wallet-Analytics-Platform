  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: 'url("https://images.unsplash.com/photo-1557683316-973673baf926?w=400")',
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-slate-800/20 via-transparent to-transparent" />
